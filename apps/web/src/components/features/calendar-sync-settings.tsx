  ...
  return (
    <div className="account-browser-push">
      ...
      <div className="account-browser-push__meta">
        <span>
          Нажмите кнопку, и сервис создаст вашу персональную ссылку календаря и попробует открыть ее как подписку.
        </span>
        <span>
          В календаре телефона будут появляться только ваши события, где вы назначены участником.
        </span>
        <span>
          Если телефон не открыл подписку сам, используйте скопированную HTTPS-ссылку вручную в приложении календаря.
        </span>
        <span>
          После перевыпуска ссылки старую подписку в календаре телефона нужно заменить вручную.
        </span>
      </div>
